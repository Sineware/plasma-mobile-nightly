...
export const repository = new Map<string,Package>([
    ...
    ["plasma-nm", { name: "plasma-nm", repo: "https://invent.kde.org/plasma/plasma-nm.git", aports_repo: "community", extraDepends: ["kcmutils-dev", "kdeclarative-dev", "qt5-qtwebengine-dev"]}],
    ...
    ["audiotube", { name: "audiotube", repo: "https://invent.kde.org/plasma-mobile/audiotube.git", aports_repo: "community", extraDepends: ["kirigami-addons-dev"], skipBuild: true}], // skip audiotube until FutureSQL 5 is in alpine
